...
`r length(unique(hz.row))` accessions contain heterozygous SNPs, and `r length(unique(hz.col))` SNPs are heterozygous in at least one accession. Given this (unexpected) evidence for heterozygous sites, I phase the data prior to haplotype clustering. 
